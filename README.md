...
1. Preprocess the dataset you wish to use (a csv file in the `data` directory). Run `scripts/ex_create_dataset_files.py` to generate the pickle file for the data. 
